...
<section class="no-results not-found">
	...
	<div class="lead"><?php _e( 'Nothing Found', 'leo_product' ); ?></div>
	...
	<div class="page-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'leo_product' ); ?></p>
			<?php get_search_form(); ?>
